...
class ChainOfResponsibilityDemo {
     ...
     */
    static RequestHandler commonRequestHandler = wrapInTransactionTag.next(createDigest).next(wrapInRequestTag);
    ...
    interface RequestHandler {
        ...
        default RequestHandler next(RequestHandler requestHandler) {
            return request -> requestHandler.handle(handle(request));
        }
    }
    /**
